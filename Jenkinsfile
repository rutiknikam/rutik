      ...
      stage('Upload Docker Images to Nexus') {
                  steps {
                      script {
                          ...
                          sh 'docker login http://15.207.111.101:8085/repository/restro-ms/ -u admin -p $(PASSWORD)'
                          echo "Push Docker Image to Nexus : In Progress"
                          sh 'docker tag Rutik 15.207.111.101:8085/Rutik:latest'
                          sh 'docker push 15.207.111.101:8085/Rutik'
